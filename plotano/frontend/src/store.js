...
// feedback (rewrite)
export const feedbackSelection = writable("all"); // Good, Bad, or NA
...
const initialTally = [{ na: 0, good: 0, bad: 0 }];
...
// export const tweenedStackedData = tweened(initialTally[0], {
//   duration: 500,
//   easing: cubicOut,
// });

// stackedData.subscribe((value) => {
//   tweenedStackedData.set(value);
// });
