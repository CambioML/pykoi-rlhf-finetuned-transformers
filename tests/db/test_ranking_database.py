...
class TestRankingDatabase(unittest.TestCase):
    ...
    def test_insert_and_retrieve_ranking(self):
        ...
        ranking_id = self.ranking_db.insert_ranking(question, up_ranking_answer, low_ranking_answer)
    ...
    def test_save_to_csv(self):
        ...
        # Insert data
        self.ranking_db.insert_ranking(question1, up_ranking_answer1, low_ranking_answer1)
        self.ranking_db.insert_ranking(question2, up_ranking_answer2, low_ranking_answer2)
        ...
        self.assertEqual(lines[0].strip(), "ID,Question,Up Ranking Answer,Low Ranking Answer")
        self.assertEqual(lines[1].strip(), f"1,{question1},{up_ranking_answer1},{low_ranking_answer1}")
        self.assertEqual(lines[2].strip(), f"2,{question2},{up_ranking_answer2},{low_ranking_answer2}")
